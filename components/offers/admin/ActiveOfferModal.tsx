// ActiveOfferModal.tsx
// Full-screen overlay modal shown when the admin clicks the eye icon on an
// active (approved) offer in the All Offers table. Displays the offer preview and
// provides Suspend / View-more actions.

"use client";

import Image from "next/image";
import { useState } from "react";
import { X, MapPin, Globe, Link as LinkIcon, CheckCircle2 } from "lucide-react";
...
interface ActiveOfferModalProps {
  offer: Offer;
  onClose: () => void;
      ...
      <div className="relative w-full max-w-[95vw] sm:max-w-[480px] md:max-w-[600px] lg:max-w-[782px] animate-in fade-in zoom-in-95">
        ...
        <div className="p-4 sm:p-5 md:p-6 lg:p-8 space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="inline-flex items-center gap-1.5 shrink-0 rounded-full bg-green-50 px-3 py-1 text-xs font-medium text-green-600">
          ...
          <div className="flex items-center gap-3 pt-1">
            <button
              ...
              className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-1 rounded-lg transition-colors text-sm"
            >
              Suspend
            </button>
            <button
