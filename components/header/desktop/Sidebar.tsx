    ...
    <>
      <div className="fixed top-0 z-[100] w-60 lg:w-50 xl:w-60 h-screen hidden lg:flex flex-col items-center justify-start border border-gray-300 bg-white">
        ...
        <div className="w-full px-2 pb-16 mt-auto">
          ...
          <button onClick={() => setIsLogoutModalOpen(true)} className="flex items-center justify-center gap-2 w-full transition-all text-primary hover:bg-primary/8 rounded-xl py-3">
            <FiLogOut size={18} />
