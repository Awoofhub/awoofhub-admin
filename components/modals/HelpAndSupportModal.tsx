...
export default function HelpAndSupportModal({ id, isOpen, onClose }: Props) {
    ...
    return (
        <div
            ...
            <div className="bg-white rounded-xl px-6 py-6 max-w-md w-full" onClick={(e) => e.stopPropagation()}>
                ...
                <h3 className="font-bold text-lg xs:text-xl text-gray-900 mb-4 text-center">See things about this user</h3>
