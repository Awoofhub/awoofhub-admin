...
export default function CloseTicketModal({ data, isOpen, onDone }: Props) {
    ...
    const onSubmit = () => {
        updateHelpAndSupport({ status: "closed" })
    };
                ...
                <div className="text-center">
                    ...
                    <div className="flex-col xs:flex-row flex gap-3">
                        <button
                            ...
                            onClick={handleClose}
                            disabled={isPending}
                            className="flex-1 cursor-pointer border rounded-sm py-2 font-baloo font-semibold text-sm xs:text-base disabled:opacity-50 border-primary text-primary"
                        >
                            Not yet
                        </button>
                        <button
                            ...
                            onClick={onSubmit}
                            disabled={isPending}
                            className="flex-1 cursor-pointer text-white rounded-sm py-2 font-baloo font-semibold text-sm xs:text-base disabled:opacity-50 flex items-center justify-center gap-2  bg-primary hover:bg-orange-700"
                        >
